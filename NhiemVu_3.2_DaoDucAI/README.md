...
- **Can thiệp của con người**:
    - Chỉnh sửa nội dung sang tiếng Việt và thay thế hình ảnh phù hợp với chủ đề.
    - Kiểm chứng thông tin, nguồn gốc để tránh sai lệch trước khi công bố.
- **Bản quyền**: Ảnh minh họa lấy từ Unsplash (theo Unsplash License); infographic của nhóm được chia sẻ theo giấy phép **CC BY 4.0**.

### 2. Giá trị đạo đức (Theo Stahl, 2021)
- **Minh bạch (Transparency)**: Ghi nhận hỗ trợ từ công cụ AI.
- **Trách nhiệm (Accountability)**: Con người trực tiếp kiểm chứng dữ liệu, thông tin làm ra.
